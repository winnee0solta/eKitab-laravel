...
class HiredBooks extends StatefulWidget {
  HiredBooks({Key key}) : super(key: key);

  @override
  _HiredBooksState createState() => _HiredBooksState();
}

class _HiredBooksState extends State<HiredBooks> {
